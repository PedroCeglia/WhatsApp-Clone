...
public class GrupoActivity extends AppCompatActivity {
    ...
    public void atualizarMembrosToolbar(){
        ...
        tvSubTitle.setText(totalSelecionados + " de " + total + " selecionados" );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerMembros = findViewById(R.id.rvMembros);
        recyclerMembrosSelecionados = findViewById(R.id.rvMembrosSelecionados);
        fabAvancarCadastro = findViewById(R.id.fabAvancarCadastro);
        tvSubTitle = findViewById(R.id.tvSubTitleGrupoCadastro);
        ivBack = findViewById(R.id.ivBackGrupoCadastro);
